            ...
            <div className="flex h-16 items-center">
              ...
              <Popover.Group className="hidden lg:ml-8 lg:block lg:self-stretch">
                <div className="flex h-full space-x-8">
                  {navigation.products.map((product) => (
                    <Popover key={product.name} className="flex">
                      {({ open }) => (
                        <>
                          ...
                          >
                            <Popover.Panel className="absolute inset-x-0 top-full bg-white text-sm text-gray-500">
                              <div
                                ...
                                aria-hidden="true"
                              />
                              {/* Draws a fake border when menu is opened */}
                              <div
        ...
        <section aria-labelledby="cause-heading">
          <div className="relative bg-gray-800 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
            ...
            <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
              ...
              >
                Promoting Inclusive Fashion for a Better Tomorrow
              </h2>
              <p className="mt-3 text-xl text-white">
                At our core, we prioritize inclusive fashion that champions
                sustainability, ethics, and responsibility. Through our
                small-scale manufacturing approach, we ensure top-notch quality
                while minimizing our environmental footprint. Every piece we
                create is a step towards a brighter, more inclusive future where
                everyone can express themselves freely and confidently. Join us
                in making a positive difference in the fashion industry and
                beyond.
              </p>
              <a
                href="#"
